...
func (s *Server) Router() http.Handler {
	...
	r.Route("/api/v1", func(r chi.Router) {
		...
		r.Route("/admin", func(r chi.Router) {
			...
			r.Get("/rounds/{round_id}/teams", s.listRoundTeams)
			r.Post("/rounds/{round_id}/teams/{team_id}/enroll", s.enrollRoundTeam)
			r.Post("/rounds/{round_id}/teams/{team_id}/pause", s.pauseRoundTeam)
			r.Post("/rounds/{round_id}/teams/{team_id}/resume", s.resumeRoundTeam)
			r.Post("/rounds/{round_id}/teams/{team_id}/withdraw", s.withdrawRoundTeam)
